...
public class CustomerRegnController {
	...
	public String saveStudentRegnDetails(Model model,@ModelAttribute("registration") Registration customerRegn)
	{
		...
		Login loginCheck = new Login(userName,password,eMail);
